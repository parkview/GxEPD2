...
{
  Serial.println("Display text file: 16");
  ...
  do
  {
    ...
    u8g2Fonts.print("Test file contents will go here! 16 ");u8g2Fonts.println(x,y);
  }
...
{
  Serial.println("Display text file: 14");
  uint16_t bg = GxEPD_WHITE;
  uint16_t fg = GxEPD_BLACK;
  u8g2Fonts.setFontMode(1);                 // use u8g2 transparent mode (this is default)
  u8g2Fonts.setFontDirection(0);            // left to right (this is default)
  ...
  do
  {
    display.fillScreen(bg);
        ...
        Serial.print("Y: ");Serial.println(y);        
    u8g2Fonts.setCursor(x, y);
    u8g2Fonts.print("Test file contents will go here! 14 ");;u8g2Fonts.println(x,y);
  }
  while (display.nextPage());
  Serial.println("Text file display done");
}
...
{
  Serial.println("Display text file: 12");
  uint16_t bg = GxEPD_WHITE;
  uint16_t fg = GxEPD_BLACK;
  u8g2Fonts.setFontMode(1);                 // use u8g2 transparent mode (this is default)
  u8g2Fonts.setFontDirection(0);            // left to right (this is default)
  ...
  do
  {
    display.fillScreen(bg);
        ...
        Serial.print("Y: ");Serial.println(y);        
    u8g2Fonts.setCursor(x, y);
    u8g2Fonts.print("Test file contents will go here! 12 ");;u8g2Fonts.println(x,y);
  }
  while (display.nextPage());
  Serial.println("Text file display done");
}
